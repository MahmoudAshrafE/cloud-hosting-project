...
const ProfileLoading = () => {
    return (
        <section className="container m-auto px-5 py-20 max-w-4xl">
            <div className="bg-slate-900 p-10 rounded-[2.5rem] border border-slate-800 shadow-xl relative overflow-hidden">
                ...
                <div className="space-y-10 relative z-10">
                    <div className="p-8 rounded-3xl bg-slate-800/30 border border-slate-800/50">
